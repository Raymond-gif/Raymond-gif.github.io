...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black, title= Governing Equations for 2D Boundary Layer Flow over Flat Plate,
]
$$    \begin{equation*}
    ...
    \text{Boundary Conditions: } \(u(x > 0, y = 0) = 0, \, v(x > 0, y = 0) = 0, \, u(x > 0, y \to \infty) = u_e(x)\)
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black, title= Third-Order Nonlinear ODE for 2D Boundary Layer Flow over Flat Plate
]
$$    \begin{equation*}
    \parbox{\textwidth}{ \centering
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{velprof.png} % Adjust width as needed
    \caption{Velocity profile $f'(\eta)$ versus $\eta$ for various values of $m$. The profiles demonstrate the influence of the Falkner-Skan parameter $m$ on boundary layer flow.}
    \label{fig:velprof}
\end{figure}

\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{falknerskanfriction.png}
    \caption{Falker Skan: Friction Coefficient vs External Velocity Parameter}
    \label{fig:falknerskanfriction}
\end{figure}

\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{blthicknessfs.png}
    \caption{Falkner Skan: Momentum Boundary Layer Thickness vs External Velocity Parameter}
    \label{fig:blthicknessfs}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{FSMTH.png}  % Adjust width as needed
    \caption{Falkner Skan: $M(\lambda) = 2T - 2(H+2)\lambda, \ T(\lambda), \ \text{and } H(\lambda)$ Plots}
    \label{fig:FSMTH}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{fsmvslambda.png}  % Adjust width as needed
    \caption{Falkner Skan: Relationship between $m = \dfrac{x}{u_e} \dfrac{du_e}{dx}$ and $\lambda = \dfrac{\Theta^2}{\nu} \dfrac{du_e}{dx}$}
\label{fig:fsmvslambda}
\end{figure}
...
\begin{figure}[htp]
    ...
    \caption{Velocity profiles for varying $\Lambda$}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{phfriction.png}  % Adjust the width as needed
    \caption{Pohlhausen Approximation: Friction Coefficient vs \(\Lambda\) and \(\lambda\)}
    \label{fig:friction}
\end{figure}
...
\begin{figure}[htp]
    \centering
    \includegraphics[width=0.6\textwidth]{Lambdalambda.png}
    \caption{Pohlhausen Approximation: Relation between $\Lambda$ and $\lambda$}
    \label{fig:Lambdalambda}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{MTHvl.png}  % Adjust the width as needed
    \caption{Pohlhausen Approximation: M,T, and H vs $\lambda$}
    \label{fig:MTHvl}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{pohl.png}
    \caption{Pohlhausen Method: variance of $\lambda$ and T over Circular Cylinder}
    \label{fig:pohllambda}
\end{figure}
...
\begin{figure}
    \centering
\includegraphics[width=0.5\linewidth]{thwaitesresults.png}
    \caption{Thwaites Fit for Various Known Solutions. Note: F corresponds to M in my notation}
    \label{fig:thwaitesresults}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{comparison.png}
    \caption{Comparison of M, T, and H Parameters for Falkner-Skan Solution, Thwaites and Pohlhausen Approximation Plotted vs $\lambda$}
    \label{fig:comparison}
\end{figure}

\section{Computation for Flow Around Circular Cylinder}
...
\addplot {1 - 4*sin(deg(x))^2};
\end{axis}
\end{tikzpicture}
\caption{Pressure coefficient around a circular cylinder in potential flow: \( C_p = 1 - 4 \sin^2(\theta) \)}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{circcyl1.png}
        \caption{$T \text{ and } \lambda$ varying over the surface of a circular cylinder}
        \label{fig:circ1}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{circ2.png}
        \caption{Skin Friction Coefficient over surface of circular cylinder}
        \label{fig:circ2}
    \end{subfigure}
    \caption{Thwaites Method: Analysis of a circular cylinder}
    \label{fig:combined}
\end{figure}
